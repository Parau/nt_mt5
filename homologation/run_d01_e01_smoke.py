"""Run TC-HOM-D01 + TC-HOM-E01 only (TradingNode quote ticks + market round-trip)."""
...
async def main() -> int:
    ...
    print(f"  WS feed : {'ENABLED' if cfg.feed_enabled else 'DISABLED'}")
    print("=" * 64)

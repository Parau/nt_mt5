"""Run TC-HOM-E43 only — cancel rejection (double-cancel → 10013)."""
...
from homologation.scenarios.exec_tester_suite import run_cancel_rejection
...
async def main() -> int:
    ...
    print("=" * 64)
    print("  TC-HOM-E43 — Cancel rejection (double-cancel → 10013)")

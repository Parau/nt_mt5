"""Run homologation wave-2 scenarios only (D06, D07, E06–E09)."""
...
from homologation.scenarios.mt5_edges import run_real_retcodes
...
async def main() -> int:
    ...
    print("=" * 64)
    print("  MT5 ADAPTER — HOMOLOGATION WAVE 2")
    ...
    for runner in (
        run_feed_service_restart_dedup,
    ...
    report.print_summary()
    json_path = os.environ.get("HOMOLOG_REPORT_JSON", "homologation/last_wave2_report.json")

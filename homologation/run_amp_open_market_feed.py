"""
run_amp_open_market_feed.py
============================

AMP / CME open-market — **real-time feed scenarios** (WS tick stream).

Container: RPyC ``127.0.0.1:18814``, feed ``ws://0.0.0.0:8767/mt5-feed``
...
async def main() -> int:
    ...
    print("=" * 64)
    print("  MT5 ADAPTER — AMP/CME OPEN MARKET (FEED / REAL-TIME TICKS)")
    ...
    json_path = os.environ.get(
        "HOMOLOG_REPORT_JSON",
        "homologation/last_amp_open_market_feed_report.json",
    )

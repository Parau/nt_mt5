...
WireInboundMessage = HelloMessage | TickBatchMessage | HeartbeatMessage | PongMessage | ErrorMessage
WireOutboundCommand = SubscribeCommand | UnsubscribeCommand | PingCommand

...
| Trade ticks | **Profile-dependent** | TC-D30 | **Tickmill:** rejeição via `VenueProfile` (`test_tc_d30_*`). **XP_B3:** subscribe passa gate + homolog open (`homologation/scenarios/trade_tick_open_market.py`). | **Tickmill:** N/A (`last=0`). **XP/B3:** WINQ26, **PETR4**, **DI1F27** live (`run_xp_symbol_quote_trade_confirm.py`, 2026-06-30); `VenueProfile` **TESTED** | `homologation/run_xp_trade_ticks_homologation.py`, `homologation/run_xp_symbol_quote_trade_confirm.py` | **Tickmill = Unsupported.** **XP_B3:** live `SubscribeTradeTicks` homologado WINQ26/PETR4/DI1F27. |
| Historical trade ticks | **Profile-dependent** | TC-D31 | **Tickmill:** FOREX/CFD rejeitados (`test_tc_d31_*`). **XP_B3:** nominais entrega `TradeTick` via fake bridge + homolog | **Tickmill:** N/A. **XP/B3:** WINQ26, **PETR4**, **DI1F27** open (`run_xp_symbol_quote_trade_confirm.py`, 2026-06-30); `VenueProfile` **TESTED** | `homologation/run_xp_trade_ticks_homologation.py`, `homologation/run_xp_symbol_quote_trade_confirm.py` | Histórico open homologado para os três nominais. |

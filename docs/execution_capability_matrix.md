...
| Limit orders | **Partial** | TC-E10–TC-E19 | **TC-EL-18/19**: GTC limit submit (BUY/SELL). **E06** homologation: IOC passive/aggressive paths. | ✅ GTC **E03**; IOC **E06**; FOK+DAY passive **E06de** (`run_wave4_homologation.py`, Tickmill BTCUSD 2026-06-28) | `test_execution_lifecycle_external_rpyc.py`, `homologation/run_homologation.py` | GTC/IOC/FOK/DAY limit submit homologados (Tickmill). Tickmill FOK may override `type_filling` to RETURN (2). GTD/paired limits unsupported. Modify/cancel de limit open: **E07** volume+price, **E43** cancel rejection. |
